      ...
      $.ajax({
        ...
        success:function(resp){
          if(resp){
            ...
            $('[name="price[3]"]').val(parseFloat(resp.senior_price).toLocaleString('en-US',{style:'decimal',minimumFractionDigits:2,maximumFractionDigits:2}))
            ...
            $('#price_senior').text(parseFloat(resp.senior_price).toLocaleString('en-US',{style:'decimal',minimumFractionDigits:2,maximumFractionDigits:2}))
